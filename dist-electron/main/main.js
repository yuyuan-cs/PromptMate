...
const { app, BrowserWindow, ipcMain, globalShortcut, Menu } = require$$1$3;
const path = require$$1;
const fs = require$$2;
const { autoUpdater } = main$1;
