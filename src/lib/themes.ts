  ...
  },
  {
    ...
    variables: {
      light: {
        ...
        "--card": "210 100% 98%",
        "--card-foreground": "200 98% 24%",
        "--popover": "210 100% 98%",
        "--popover-foreground": "200 98% 24%",
        "--primary": "200 98% 39%",
  ...
  },
  {
    ...
    variables: {
      light: {
        ...
        "--card": "270 100% 99%",
        "--card-foreground": "280 84% 32%",
        "--popover": "270 100% 99%",
        "--popover-foreground": "280 84% 32%",
        "--primary": "270 76% 56%",
  ...
  },
  {
    ...
    variables: {
      light: {
        ...
        "--card": "140 84% 98%",
        "--card-foreground": "150 60% 20%",
        "--popover": "140 84% 98%",
        "--popover-foreground": "150 60% 20%",
        "--primary": "142 71% 36%",
        "--primary-foreground": "0 0% 100%",
        "--secondary": "140 84% 93%",
  ...
  },
  {
    ...
    variables: {
      light: {
        ...
        "--foreground": "20 90% 25%",
        "--card": "30 100% 99%",
        "--card-foreground": "20 90% 25%",
        "--popover": "30 100% 99%",
        "--popover-foreground": "20 90% 25%",
        "--primary": "20 90% 35%",
        "--primary-foreground": "0 0% 100%",
        "--secondary": "30 100% 94%",
        "--secondary-foreground": "20 90% 35%",
        "--accent": "30 100% 94%",
        "--accent-foreground": "20 90% 35%",
        "--muted": "30 100% 94%",
        "--muted-foreground": "20 90% 25%",
        "--border": "30 100% 90%",
        "--input": "30 100% 90%",
        "--ring": "20 90% 35%",
        "--sidebar-background": "30 100% 99%",
        "--sidebar-foreground": "20 90% 25%",
        "--sidebar-primary": "20 90% 35%",
  ...
  },
  {
    ...
    variables: {
      light: {
        ...
        "--primary-foreground": "0 0% 100%",
        "--secondary": "0 100% 94%",
        "--secondary-foreground": "0 70% 45%",
        "--accent": "0 100% 94%",
        "--accent-foreground": "0 70% 45%",
        "--muted": "0 100% 94%",
        "--muted-foreground": "0 70% 25%",
        "--border": "0 100% 90%",
        "--input": "0 100% 90%",
        "--ring": "0 70% 45%",
        "--sidebar-background": "0 100% 99%",
        "--sidebar-foreground": "0 70% 25%",
